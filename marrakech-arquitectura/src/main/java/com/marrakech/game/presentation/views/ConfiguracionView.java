...
public class ConfiguracionView extends StackPane {
    ...
    private void configurarContenido() {
        ...
        opciones.getChildren().addAll(
            ...
            crearSlider("Sensibilidad", 0, 100, 50),
            ...
            crearSlider("Volumen general", 0, 100, 70)
        );
    ...
    private VBox crearSlider(String etiqueta, double min, double max, double valor) {
        ...
        slider.setStyle(
            "-fx-control-inner-background: #2A1800;" +
            "-fx-accent: #C9922A;"
        );
        ...
        VBox box = new VBox(4, cabecera, slider);
        return box;
    }
